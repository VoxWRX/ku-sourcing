...
const ProductRecommendations = ({ onProductSelect }) => {
    ...
    return (
        <div className="p-10">
            ...
            <p className="text-lg text-blue-500 text-center mb-4 ml-6">We have some top products just for you</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {recommendedProducts.map(product => (
                    <div key={product.id}
                        ...
                        onClick={() => typeof onProductSelect === 'function' && onProductSelect(product)}
                    >
