  ...
  return (
    <header>
      <nav className="relative flex max-w-full items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex">
          <a href="/user-dashboard" className="-m-1.5 p-1.5">
            ...
            <img className="w-12 mx-6" src="/kuai-sourcing-logo.svg" alt="kuai-sourcing" />
          </a>
        </div>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <a data-aos="fade-up" data-aos-duration="1200"
            ...
            <p><TranslateComponent text="Dashboard" /></p>
          </a>
          ...
          <a href="/user-sourcing-requests"
            ...
            <p><TranslateComponent text="Sourcing Requests" /></p>
          </a>
          ...
          <a data-aos="fade-up" data-aos-duration="1200"
            ...
            <p><TranslateComponent text="Handling Requests" /></p>
          </a>
          ...
          <a data-aos="fade-up" data-aos-duration="1200"
            ...
            <p><TranslateComponent text="Sourcing Orders" /></p>
          </a>
      ...
      <Transition.Root show={mobileMenuOpen} as={Fragment}>
        <Dialog as="div" className="relative z-40 lg:hidden" onClose={() => setMobileMenuOpen(false)}>
          <Transition.Child
            as={Fragment}
                          ...
                          <Dialog.Title className="text-lg font-medium">
                            <a href="/user-dashboard" className="-m-1.5 p-1.5">
                              ...
                              <img
                                ...
                                src="/kuai-sourcing-logo.svg" alt="kuai-sourcing"
                              />
                            </a>
                          </Dialog.Title>
                          ...
                          <div className="-my-6 divide-y divide-gray-500/10">
                            <div className="space-y-2 py-6">
                              ...
                              >
                                ...
                                <p className='my-2'>
                                  <TranslateComponent text="Dashboard" /></p>
                              </a>
                              ...
                              >
                                ...
                                <p className='my-2'>
                                  <TranslateComponent text="Sourcing Requests" /></p>
                              </a>
                              ...
                              >
                                ...
                                <p className='my-2'>
                                  <TranslateComponent text="Handling Requests" /></p>
                              </a>
                              ...
                              >
                                ...
                                <p className='my-2'>
                                  <TranslateComponent text="Sourcing Orders" /></p>
                              </a>
