...
export default function Footer() {
  ...
  return (
    <footer className="footer items-center p-4 bg-neutral text-neutral-content w-full">
      <aside className="items-center pl-10 grid-flow-col">
        ...
        <p className="font-sans">Copyright © 2024 - All rights reserved by</p>
        <p className="text-blue-300"><b>Kuai Sourcing</b></p>
      </aside>

      <nav className="grid-flow-col gap-4 mr-8 md:place-self-center md:justify-self-end">
        <p>Made By
          <b className="text-blue-400"><a href="https://badr-mellal.netlify.app/" target="_blank"> Badr</a></b>
        </p>
        <a href="https://github.com/badrmellal" target="_blank">
          <FaGithub className='w-6 h-6' />

        </a>
        <a href="https://www.linkedin.com/in/badr-mellal-207a34201/" target="_blank">
          <FaLinkedin className='w-6 h-6' />

        </a>
        <a href="https://www.instagram.com/badr_wireshark" target="_blank">
